...
# Run from local dev machine. Merges tradingAI0.1 -> main, tags, deploys to swiss-knife.
# Usage: ./release.sh
set -e

NODE_IP="192.168.0.139"
NODE_USER="kamilo420"
TARGET_DIR="/home/kamilo420/projects/finance/tickerTap"
INTEGRATION_BRANCH="tradingAI0.1"
DB_CONTAINER="tickertap-db"
DB_NAME="tickertap"
DB_USER="postgres"
KUMA_PUSH_URL=""  # TODO: create Push monitor in roach:3001, paste URL here
