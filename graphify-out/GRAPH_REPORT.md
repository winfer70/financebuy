# Graph Report - /home/REDACTED420/projects/finance/tickerTap  (2026-06-11)
...
7. `RuleAlertData` - 114 edges
8. `BacktestResult` - 110 edges
9. `RuleContext` - 108 edges
10. `PaperTradeEquitySnapshot` - 103 edges

## Surprising Connections (you probably didn't know these)
- `Strategy` --uses--> `main.py — FastAPI application entry point for TickerTap.  Configures middlewar`  [INFERRED]
  /home/REDACTED420/projects/finance/tickerTap/backend/app/models.py → /home/REDACTED420/projects/finance/tickerTap/backend/app/main.py
- `Insert system strategy templates if the strategies table is empty.      Reads te` --uses--> `Strategy`  [INFERRED]
  /home/REDACTED420/projects/finance/tickerTap/backend/app/main.py → /home/REDACTED420/projects/finance/tickerTap/backend/app/models.py
...
Cohesion: 0.02
Nodes (96): auth_client(), make_all_result(), make_scalar_count_result(), make_scalar_result(), make_scalars_result(), mock_db_session(), mock_user(), ============================================================================ Sha (+88 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (124): generate_signals(), indicator_outputs(), ADX Trend Strategy — enter on strong trend confirmation via ADX.  Enter long whe, Expose indicator series for the composition engine.      Args:         bars:   C, Wilder's smoothing (used in ADX/DI calculations).      Args:         values: Raw, Generate entry/exit signals based on ADX trend strength.      Args:         bars, _wilder_smooth(), generate_signals() (+116 more)
...
## Knowledge Gaps
- **924 isolated node(s):** `learner.py — TickerTap scoring accuracy analyser for Server B (REDACTED_HOST).  Standal`, `Fetch score outcome records from Server A.      Retrieves up to 2000 of the mo`, `Compute aggregate accuracy statistics from outcome data.      Breaks down accu`, `Build a prompt for the LLM to analyse scoring patterns and biases.      Includ`, `Call the local Ollama API to analyse scoring patterns.      Uses streaming mod` (+919 more)
