...
_SYSTEM_PROMPT = (
    ...
    "add/modify/sell/delete positions, stop-loss tracking, exclude/include toggle, "
    "price change period selector (1D/5D/1M/3M/6M/1Y), bulk SMA with alerts, "
    "CSV import/export, sortable columns, cross-page nav (VIEW CHART/VIEW NEWS), group tags, "
    ...
    "8 drawing tools (trend line, horizontal line, ray, rectangle, Fibonacci, pitchfork, "
    "arrow, text) with colour/width/style options, chart template save/load, "
    ...
    "sentiment filter (ALL/BULLISH/BEARISH), portfolio toggle, source badges "
    ...
    "Portfolio CSV export (Ticker/Name/Qty/Date/Price/AssetType/GroupTag/StopLoss), "
