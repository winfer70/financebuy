...
const INTERMEDIATE_TOPICS = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Time decay (Theta) erodes option value every day, accelerating as expiration approaches. This is why 80% of options expire worthless — time is always working against option buyers and for option sellers.",
