...
```bash
cd /home/kamilo420/projects/finance/tickerTap
...
```bash
grep -r "8001" /home/kamilo420/projects/finance/tickerTap/backend/app/ --include="*.py"
grep -r "8001" /home/kamilo420/projects/finance/tickerTap/frontend/src/ --include="*.js" --include="*.jsx"
```
...
```bash
grep -r "trading.ml\|trading-ml\|8001" /home/kamilo420/projects/finance/tickerTap/*.yml \
  /home/kamilo420/projects/finance/tickerTap/*.yaml 2>/dev/null
```
...
### Problem
`/home/kamilo420/ai-agent-stack/docker-compose.yml` line 13:
```yaml
ports:
  - "5432:5432"
```
...
### Fix
**File: `/home/kamilo420/ai-agent-stack/docker-compose.yml`**
...
### Deploy
```bash
cd /home/kamilo420/ai-agent-stack
...
nc -zv 192.168.0.139 5432  # should REFUSE
```
...
### Problem
The n8n monitor at `/home/kamilo420/ai-agent-stack/monitor/main.py` checks TickerTap
via `GET http://192.168.0.139:8000/health` but has no visibility into individual arq
...
**File: `/home/kamilo420/ai-agent-stack/monitor/main.py`**

Find the section that checks TickerTap (`http://192.168.0.139:8000/health`) and add a
...
async def check_tickertap_workers(session: aiohttp.ClientSession) -> dict:
    ...
    url = "http://192.168.0.139:8000/api/v1/metrics/workers"
    try:
...
2. Rebuild and restart monitor: `cd /home/kamilo420/ai-agent-stack && docker compose up -d --build monitor`

### Verify
```bash
curl -s http://192.168.0.139:8000/api/v1/metrics/workers | python3 -m json.tool
```
